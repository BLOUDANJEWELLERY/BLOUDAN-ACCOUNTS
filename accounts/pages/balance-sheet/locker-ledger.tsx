        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <span className="inline-flex px-6 py-3 rounded-full text-lg font-semibold bg-emerald-100 text-emerald-800 border border-emerald-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl p-6 border-2 border-emerald-300 transform hover:-translate-y-1 transition-transform duration-300">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-emerald-700">Total Transactions</p>
                  <p className="text-2xl font-bold text-emerald-800">{allVouchers.length}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl p-6 border-2 border-emerald-300 transform hover:-translate-y-1 transition-transform duration-300">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-emerald-700">Current Locker Balance</p>
                  <p className="text-2xl font-bold text-emerald-800">{formatBalance(currentLockerBalance)}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl p-6 border-2 border-emerald-300 transform hover:-translate-y-1 transition-transform duration-300">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-emerald-700">Filtered Transactions</p>
                  <p className="text-2xl font-bold text-emerald-800">{filteredVouchers.length}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl p-6 border-2 border-emerald-300 transform hover:-translate-y-1 transition-transform duration-300">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-emerald-700">Net Change</p>
                  <p className={`text-xl font-bold ${netGoldChange >= 0 ? 'text-emerald-800' : 'text-amber-700'}`}>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl p-8 mb-8 border-2 border-emerald-300 relative overflow-hidden">
            <div className="absolute top-0 left-0 w-32 h-32 bg-gradient-to-br from-emerald-200 to-emerald-400 rounded-full -translate-x-16 -translate-y-16 opacity-20"></div>
            ...
            <div className="text-center mb-6">
              <h2 className="text-2xl font-bold text-emerald-800">Locker Balance Summary</h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
              ...
              <div className="rounded-2xl p-6 text-center shadow-lg border-2 bg-gradient-to-r from-emerald-500 to-emerald-600 border-amber-400 text-white transform hover:-translate-y-1 transition-transform duration-300">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-3 items-end">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full min-w-0 box-border rounded-xl border-2 border-emerald-300 bg-white/80 px-4 py-3 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors"
                  />
                </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <button
                      ...
                      className="flex-1 min-w-[120px] rounded-xl px-4 py-3 text-sm font-semibold text-white bg-gradient-to-r from-emerald-500 to-emerald-700 border-2 border-amber-400 shadow-lg transition-all duration-300 hover:-translate-y-0.5 hover:from-emerald-600 hover:to-emerald-800 hover:shadow-xl"
                    >
                      Last Month
                    </button>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center">
              ...
              <div className="flex gap-6 mt-4 sm:mt-0">
                <div className="text-center">
                  <p className="text-sm text-emerald-700 font-medium">Gold Debit</p>
                  <p className="text-xl font-bold text-red-700">{formatCurrency(totalGoldDebit)} g</p>
                </div>
                <div className="text-center">
                  <p className="text-sm text-emerald-700 font-medium">Gold Credit</p>
                  <p className="text-xl font-bold text-green-700">{formatCurrency(totalGoldCredit)} g</p>
                </div>
                <div className="text-center">
                  <p className="text-sm text-emerald-700 font-medium">Net Change</p>
                  <p className={`text-xl font-bold ${netGoldChange >= 0 ? 'text-emerald-800' : 'text-amber-700'}`}>
                    {formatBalance(netGoldChange)}
                  </p>
                </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden border-2 border-emerald-300">
            <div className="px-6 py-4 border-b-2 border-emerald-300 bg-emerald-100">
              <div className="flex items-center justify-between">
                <h2 className="text-2xl font-bold text-emerald-800">Locker Gold Transactions</h2>
                ...
                <table className="min-w-full border-collapse">
                  ...
                  <tbody className="divide-y divide-emerald-300">
                    <tr className="bg-yellow-50">
                      <td className="border border-emerald-300 px-4 py-3 text-center text-sm text-gray-700">
                        {dateRange.start ? formatDate(dateRange.start) : "Beginning"}
                      </td>
                      <td colSpan={5} className="border border-emerald-300 px-4 py-3 text-center">
                        <span className="font-semibold text-gray-800">Opening Locker Balance</span>
                      </td>
                      <td className="border border-emerald-300 px-4 py-3 text-center font-mono font-semibold text-emerald-800">
                    ...
                    {filteredVouchers.map((v, index) => (
                      <tr 
                        ...
                        className={`transition-colors duration-150 ${
                          !affectsLocker(v) ? 'bg-gray-50 opacity-75' : 'bg-white hover:bg-emerald-50/50'
                        }`}
                      >
                        <td className="border border-emerald-300 px-4 py-3 whitespace-nowrap text-sm text-emerald-700 text-center">
                          {formatDate(v.date)}
                        </td>
                        <td className="border border-emerald-300 px-4 py-3 text-center">
                          <div className="flex flex-col">
                            <span className="font-semibold text-emerald-900">{v.account.name}</span>
                            <span className="text-xs text-emerald-600">#{v.account.accountNo}</span>
                        ...
                        <td className="border border-emerald-300 px-4 py-3 whitespace-nowrap text-sm text-center font-mono">
                        ...
                        <td className={`border border-emerald-300 px-4 py-3 whitespace-nowrap text-sm text-center font-mono font-semibold ${
                          v.lockerGoldBalance >= 0 ? "text-emerald-800" : "text-amber-700"
                        }`}>
                    ...
                    <tr className="bg-emerald-50">
                      ...
                      <td className="border border-emerald-300 px-4 py-3 text-center font-mono font-bold text-emerald-800">
                  ...
                  <tfoot className="bg-emerald-100">
                    <tr>
                      <td colSpan={4} className="border border-emerald-300 px-4 py-4 text-sm font-semibold text-emerald-800 text-right">
                        Totals:
                      </td>
                      <td className="border border-emerald-300 px-4 py-4 whitespace-nowrap text-sm text-center font-mono font-bold text-red-700">
                        {totalGoldDebit.toFixed(3)}
                      </td>
                      <td className="border border-emerald-300 px-4 py-4 whitespace-nowrap text-sm text-center font-mono font-bold text-green-700">
                        {totalGoldCredit.toFixed(3)}
                      </td>
                      <td className="border border-emerald-300 px-4 py-4 whitespace-nowrap text-sm text-center font-mono font-bold text-emerald-800">
                        {formatBalance(calculateClosingBalance)}
                      </td>
                    </tr>
                  </tfoot>
          ...
          {/* Legend */}
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl p-6 mt-8 border-2 border-emerald-300">
            <h3 className="text-2xl font-bold text-emerald-800 mb-6">Locker Gold Rules</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h4 className="text-lg font-semibold text-emerald-700 mb-4">Market Accounts</h4>
                <div className="space-y-3">
              ...
              <div>
                <h4 className="text-lg font-semibold text-emerald-700 mb-4">Other Accounts</h4>
                <div className="space-y-3">
                  <div className="flex items-start">
                    <span className="inline-flex px-3 py-1 text-sm font-semibold rounded-full bg-red-100 text-red-800 border border-red-300 mr-3 mt-1">
                      INV
